...
public class MapTileOverlay {
    ...
    public MapTileOverlay(Activity activity, GoogleMap googleMap){
        TileProvider coordTileProvider = new CoordTileProvider(activity.getApplicationContext());
        googleMap.addTileOverlay(new TileOverlayOptions().tileProvider(coordTileProvider));
    }
