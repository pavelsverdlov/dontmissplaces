...
public class SaveTrackActivity extends AppCompatActivityView<SaveTrackPresenter>
    ...
    public static class ViewState extends com.svp.infrastructure.mvpvs.viewstate.ViewState<SaveTrackActivity> {
        ...
        public BundleProvider getBundle(){ return view.bundle; }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        bundle = BundleProvider.create(savedInstanceState,this);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                getPresenter().save();
                Snackbar.make(view, getString(R.string.snackbar_activity_save_track_was_saved), Snackbar.LENGTH_LONG)
                        .show();
            }
        });
