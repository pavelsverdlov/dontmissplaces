...
public class GPSLoggerServiceManager
{
    ...
    public GPSLoggerServiceManager(Context ctx) {
        ctx.startService(GPSLoggerService.createServiceIntent(ctx));//new Intent(Constants.SERVICENAME));
    }
...
//                     Log.d( TAG, "onServiceDisconnected()"+ Thread.currentThread().getId() );
                ...
                context.bindService(GPSLoggerService.createServiceIntent(context), // new Intent( Constants.SERVICENAME ),
